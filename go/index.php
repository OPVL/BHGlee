...
<body onload="handleResponse('<?=$searchTerm?>')">
    ...
    <div class="card-footer text-muted text-center bottom bg-light"
        style="position:fixed; bottom: 0; width: 100%; height: 60px; z-index: 100;">
        Not what you wanted? Try <a data-toggle="collapse" href="#collapsibleNavId" aria-controls="collapsibleNavId"
            aria-expanded="false">Searching Again</a>.
        <div class="credit">
